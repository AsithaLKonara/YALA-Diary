...
export default function SettingsPage() {
  const [hotelName, setHotelName] = useState("Mahoora by Eco Team Yala");
  const [address, setAddress] = useState("Yala National Park, Tissamaharama, Sri Lanka");
  const [phone, setPhone] = useState("+94 77 000 0000");
  const [email, setEmail] = useState("reservations@yaladiary.com");
  const [website, setWebsite] = useState("https://yaladiary.com");
